class IconMaker {
    ...
    draw(e) {
        ...
        if (this.currentShape === 'none') {
            ...
            this.ctx.stroke();
        } else this.redrawWithPreview(coords.x, coords.y);
    }
    stopDrawing() {
        if (!this.isDrawing) return;
        this.isDrawing = false;
        if (this.currentShape !== 'none') this.saveToHistory();
        else this.saveToHistory();
    }
...
//# sourceMappingURL=hand-drawn-icon-maker.aa69868b.js.map
